...
function addItem(card, itemText = null) {
    if (itemText == null) {
        itemText = getItem();
    }
...
var card = addTask("Trip to Paris");
var tmpItem = addItem(card, "Visit Church");
tmpItem.querySelector("input").checked = true;
removeItem(tmpItem);
addItem(card, "Shopping");